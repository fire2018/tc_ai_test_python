...
class BlurredImageRecognition(object):
    def __init__(self, app_id, app_key):
        ...
        """
        self.request_url = "https://api.ai.qq.com/fcgi-bin/image/image_fuzzy"
        self.me_data = {
            "app_id": app_id,
            "app_key": app_key
        }
    ...
    def start(self, img_path):
        ...
        :return: JSon数据
        """
        request_AI_BlurredImageRecognition = {
        ...
        request_AI_BlurredImageRecognition["sign"] = self.calculate_sign(request_AI_BlurredImageRecognition,
                                                                         self.me_data["app_key"])
        request_data = sorted(request_AI_BlurredImageRecognition.items())
