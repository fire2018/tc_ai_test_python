...
class ObjectRecognition(object):
    def __init__(self, app_id, app_key):
        ...
        """
        self.request_url = "https://api.ai.qq.com/fcgi-bin/vision/vision_objectr"
        self.me_data = {
            "app_id": app_id,
            "app_key": app_key
        }
    ...
    def start(self, img_path, to_pk=5):
        ...
        request_AI_ObjectRecognition["sign"] = self.calculate_sign(request_AI_ObjectRecognition,
                                                                   self.me_data["app_key"])
        request_data = sorted(request_AI_ObjectRecognition.items())
