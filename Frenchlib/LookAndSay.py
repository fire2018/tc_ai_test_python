...
class LookAndSay(object):
    def __init__(self, app_id, app_key):
        ...
        """
        self.request_url = "https://api.ai.qq.com/fcgi-bin/vision/vision_imgtotext"
        self.me_data = {
            "app_id": app_id,
            "app_key": app_key
        }
    ...
    def calculate_session():
        ...
        data = "AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz0123456789"
        for i in range(1, 15):
            session = data[random.randint(1, len(data) - 1)]
        return session
    ...
    def start(self, img_path):
        ...
        request_AI_LookAndSay = {
            ...
            "session_id": self.calculate_session()
        }
        request_AI_LookAndSay["sign"] = self.calculate_sign(request_AI_LookAndSay, self.me_data["app_key"])
        request_data = sorted(request_AI_LookAndSay.items())
