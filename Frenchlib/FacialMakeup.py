...
class FacialMakeup(object):
    def __init__(self, app_id, app_key):
        ...
        """
        self.request_url = "https://api.ai.qq.com/fcgi-bin/ptu/ptu_facecosmetic"
        self.me_data = {
            "app_id": app_id,
            "app_key": app_key
        }
    ...
    def start(self, cosmetic, img_path):
        """

        :param cosmetic: 美妆编码(int)
        :param img_path: 图片路径(Str)
        :return: json数据
        """
        request_AI_FacialMakeup = {
        ...
        request_AI_FacialMakeup["sign"] = self.calculate_sign(request_AI_FacialMakeup, self.me_data["app_key"])
        request_data = sorted(request_AI_FacialMakeup.items())
