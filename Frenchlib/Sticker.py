...
class Sticker(object):
    def __init__(self, app_id, app_key):
        ...
        """
        self.request_url = "https://api.ai.qq.com/fcgi-bin/ptu/ptu_facesticker"
        self.me_data = {
            "app_id": app_id,
            "app_key": app_key
        }
    ...
    def start(self, sticker, img_path):
        """

        :param sticker: 大头贴编码  (int)
        ...
        request_AI_Sticker["sign"] = self.calculate_sign(request_AI_Sticker, self.me_data["app_key"])
        request_data = sorted(request_AI_Sticker.items())
