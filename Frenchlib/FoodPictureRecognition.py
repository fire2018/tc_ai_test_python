...
class FoodPictureRecognition(object):
    def __init__(self, app_id, app_key):
        ...
        """
        self.request_url = "https://api.ai.qq.com/fcgi-bin/image/image_food"
        self.me_data = {
            "app_id": app_id,
            "app_key": app_key
        }
    ...
    def start(self, img_path):
        ...
        :return: JSON数据
        """
        request_AI_FoodPictureRecognition = {
        ...
        request_AI_FoodPictureRecognition["sign"] = self.calculate_sign(request_AI_FoodPictureRecognition,
                                                                        self.me_data["app_key"])
        request_data = sorted(request_AI_FoodPictureRecognition.items())
