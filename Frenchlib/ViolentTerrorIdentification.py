...
class ViolentTerrorIdentification(object):
    def __init__(self, app_id, app_key):
        ...
        """
        self.request_url = "https://api.ai.qq.com/fcgi-bin/image/image_terrorism"
        self.me_data = {
            "app_id": app_id,
            "app_key": app_key
        }
    ...
    def start(self, img_path):
        ...
        :return: JSON数据
        """
        request_AI_ViolentTerrorIdentification = {
        ...
        request_AI_ViolentTerrorIdentification["sign"] = self.calculate_sign(request_AI_ViolentTerrorIdentification, self.me_data["app_key"])
        request_data = sorted(request_AI_ViolentTerrorIdentification.items())
