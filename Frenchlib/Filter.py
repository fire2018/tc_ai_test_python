...
class Filter(object):
    def __init__(self, app_id, app_key):
        ...
        """
        self.request_url = "https://api.ai.qq.com/fcgi-bin/ptu/ptu_imgfilter"
        self.me_data = {
            "app_id": app_id,
            "app_key": app_key
        }
    ...
    def start(self, filters, img_path):
        """

        :param filters: 滤镜特效编码 (int)
        ...
        request_AI_Filter["sign"] = self.calculate_sign(request_AI_Filter, self.me_data["app_key"])
        request_data = sorted(request_AI_Filter.items())
