...
class VisitingCardIdentification(object):
    def __init__(self, app_id, app_key):
        ...
        """
        self.request_url = "https://api.ai.qq.com/fcgi-bin/ocr/ocr_bcocr"
        self.me_data = {
            "app_id": app_id,
            "app_key": app_key
        }
    ...
    def start(self, img_path):
        ...
        :return: JSON数据
        """
        request_AI_VisitingCardIdentification = {
        ...
        request_AI_VisitingCardIdentification["sign"] = self.calculate_sign(request_AI_VisitingCardIdentification,
                                                                            self.me_data["app_key"])
        request_data = sorted(request_AI_VisitingCardIdentification.items())
